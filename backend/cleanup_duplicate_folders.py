...
def cleanup_duplicate_folders():
    ...
    try:
        ...
        print(f"   Parent: {bad_finance.parent.name if bad_finance.parent else 'RACINE (NULL)'}")
        ...
        if depts.exists():
            ...
            print(f"   ✅ Aucun département associé")
            bad_finance.delete()
    ...
    if orphans.exists():
        ...
        for folder in orphans:
            ...
            status = "🗑️  PEUT ÊTRE SUPPRIMÉ" if is_orphan else "✅ EN COURS D'UTILISATION"
