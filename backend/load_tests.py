...
class SGDRAUser(HttpUser):
    ...
    def upload_document(self):
        ...
        files = {
            "file": ("test_document.xlsx", BytesIO(excel_content), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"),
...
def on_test_start(environment, **kwargs):
    ...
    print(f"   Durée: Jusqu'à arrêt manuel")
    print(f"   Interface web: http://localhost:8089\n")
