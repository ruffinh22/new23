...
class NotificationConsumer(AsyncWebsocketConsumer):
    ...
    async def disconnect(self, close_code):
        ...
        print(f"❌ Notification WebSocket déconnecté")
...
class AuditLogConsumer(AsyncWebsocketConsumer):
    ...
    async def disconnect(self, close_code):
        ...
        print(f"❌ AuditLog WebSocket déconnecté")
        ...
        return [
            {
                ...
                'severity_display': dict(AuditLog.SEVERITY_CHOICES).get(log.severity, log.severity),
