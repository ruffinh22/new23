            ...
            with transaction.atomic():
                ...
                for pole in poles:
                    ...
                    for idx, country in enumerate(self.COUNTRIES):
                        ...
                        filiale_code = f"POL_{pole.code.split('_')[1]}_{country_code_suffix}"
                ...
                total_poles_with_filiales = Folder.objects.filter(
                    folder_type='filiale'
                ).values('parent__id').distinct().count()
                ...
                self.say(f"   Pôles with Filiales: {total_poles_with_filiales}\n", 'bold')
