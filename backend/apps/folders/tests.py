...
class PoleViewSetTestCase(TestCase):
    ...
    def test_pole_detail(self):
        ...
        response = self.client.get(f"/api/folders/poles/{pole.id}/", **self.headers)
    ...
    def test_pole_filiales_action(self):
        ...
        response = self.client.get(
            f"/api/folders/poles/{pole.id}/filiales/", **self.headers
        )
    ...
    def test_poles_with_counts(self):
        ...
        response = self.client.get("/api/folders/poles/with_counts/", **self.headers)
...
class FilialeViewSetTestCase(TestCase):
    ...
    def test_filiale_detail(self):
        ...
        response = self.client.get(
            f"/api/folders/filiales/{filiale.id}/", **self.headers
        )
    ...
    def test_filiales_by_pole(self):
        ...
        response = self.client.get("/api/folders/filiales/by_pole/", **self.headers)
    ...
    def test_filiales_by_country(self):
        ...
        response = self.client.get("/api/folders/filiales/by_country/", **self.headers)
...
class ServiceViewSetTestCase(TestCase):
    ...
    def test_service_detail(self):
        ...
        response = self.client.get(
            f"/api/folders/services/{service.id}/", **self.headers
        )
    ...
    def test_services_by_type(self):
        ...
        response = self.client.get("/api/folders/services/by_type/", **self.headers)
...
class FilteringAndSearchTestCase(TestCase):
    ...
    def test_pole_search_by_name(self):
        ...
        response = self.client.get(
            "/api/folders/poles/?search=Administration", **self.headers
        )
    ...
    def test_filiale_search_by_code(self):
        ...
        response = self.client.get(
            "/api/folders/filiales/?search=POL_ADM_EN", **self.headers
        )
    ...
    def test_filiale_filter_by_parent(self):
        ...
        pole = Folder.objects.get(code="POL_ADM")
        response = self.client.get(
            f"/api/folders/filiales/?parent={pole.id}", **self.headers
        )
    ...
    def test_service_filter_by_parent(self):
        ...
        filiale = Folder.objects.get(code="POL_ADM_EN")
        response = self.client.get(
            f"/api/folders/services/?parent={filiale.id}", **self.headers
        )
...
class HierarchyNavigationTestCase(TestCase):
    ...
    def test_pole_to_filiales_navigation(self):
        ...
        response = self.client.get(
            f"/api/folders/poles/{pole_data['id']}/filiales/", **self.headers
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_filiale_to_services_navigation(self):
        ...
        response = self.client.get(
            f"/api/folders/filiales/{filiale_data['id']}/services/", **self.headers
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
