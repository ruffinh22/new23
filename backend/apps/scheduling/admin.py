...
class EmailScheduleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informations de base", {"fields": ("id", "subject", "message")}),
        ("Destinataires", {"fields": ("recipient_type", "recipient_folder")}),
        ("Programmation", {"fields": ("scheduled_at",)}),
        ("Métadonnées", {"fields": ("created_by", "created_at", "updated_at")}),
        ("Résultat", {"fields": ("status", "sent_at", "error_message")}),
    )
...
class EventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informations de base", {"fields": ("id", "title", "description", "image")}),
        (
            "Dates et lieu",
            {"fields": ("event_date", "start_time", "end_time", "location")},
        ),
        ("Visibilité", {"fields": ("is_public", "visible_to_folder")}),
        (
            "Métadonnées",
