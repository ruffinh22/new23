...
class EmailScheduleListSerializer(serializers.ModelSerializer):
    ...
    recipient_folder_name = serializers.CharField(
        source="recipient_folder.name", read_only=True, allow_null=True
    )
...
class EventListSerializer(serializers.ModelSerializer):
    ...
    visible_to_folder_name = serializers.CharField(
        source="visible_to_folder.name", read_only=True, allow_null=True
    )
