...
class AuditLogViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['description', 'actor__matricule', 'actor__first_name', 'actor__last_name']
    ...
    def stats(self, request):
        ...
        return Response({
            ...
            'success_rate': int((total_logs - failed_logs) / total_logs * 100) if total_logs > 0 else 0,
            'logs_24h': logs_24h,
