...
def get_logging_config():
    ...
    if enable_file_logging:
        ...
        logging_config["loggers"]["django"]["handlers"].extend(
            ["file_all", "file_errors"]
        )
        logging_config["loggers"]["apps"]["handlers"].extend(
            ["file_all", "file_errors", "file_audit"]
        )
        logging_config["loggers"]["apps.documents"]["handlers"].extend(
            ["file_all", "file_errors", "file_audit"]
        )
        logging_config["loggers"]["apps.users"]["handlers"].extend(
            ["file_all", "file_errors", "file_audit", "file_auth"]
        )
