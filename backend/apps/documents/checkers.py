...
from .validators import ExcelAdvancedValidator, ValidationService
from .models import Document, DocumentSpecification
...
class DocumentChecker:
    ...
    def _check_validation_status(self):
        ...
        self.checks_results[check_name] = {
            ...
            'validated_at': self.document.validated_at.isoformat() if self.document.validated_at else None
        }
    ...
    def _check_file_integrity(self):
        ...
        try:
            ...
            self.errors.append(f"Impossible de vérifier l'intégrité du fichier: {str(e)}")
            self.checks_results[check_name] = {
                'status': 'FAILED',
    ...
    def check_file_validity(file, document_type: str = None) -> Dict:
        ...
        if file_format in ['xlsx', 'xls', 'xlsm']:
            try:
                ...
                checks['is_valid'] = False
                checks['errors'].append(f"Erreur lors de la vérification du fichier Excel: {str(e)}")
