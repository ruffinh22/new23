...
class DocumentTemplateListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'created_by_name', 'is_active', 'version',
            'created_at', 'updated_at', 'file_url',
            'visibility'
        ]
        read_only_fields = [
            'id', 'file_size', 'file_type', 'downloads_count',
            'created_by_name', 'created_at', 'updated_at', 'file_url'
        ]
...
class DocumentTemplateDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            'id', 'file_size', 'file_type', 'downloads_count',
            'created_by_name', 'created_at', 'updated_at', 'versions'
        ]
