...
from apps.documents.validators import DocumentValidator, ValidationService
...
class TestDocumentValidator(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            matricule='TEST001',
            email='test@example.com', first_name='Test', last_name='User', department='RH',
...
class TestDocumentService(TestCase):
    ...
    def test_reject_document(self):
        ...
        DocumentService.reject_document(
            document,
            'Format invalide',
            admin_user
        )
