...
router.register(
    r"file-type-configurations",
    FileTypeConfigurationViewSet,
    basename="file-type-configuration",
)
router.register(
    r"specifications", DocumentSpecificationViewSet, basename="document-specification"
)
router.register(
    r"validation-results",
    DocumentValidationResultViewSet,
    basename="document-validation-result",
)
