...
class NotificationService:
    ...
    def create_notification(recipient, notification_type, title, message, 
                           ...
                           group_key=None, send_async=True):
        """
        ...
        try:
            ...
            log_error('Failed to create notification', exception=e, logger_instance=notifications_logger)
            raise
    ...
    def batch_create_notifications(notifications_data, group_by=False):
        ...
        try:
            ...
            log_error('Batch create failed', exception=e, logger_instance=notifications_logger)
            raise
    ...
    def mark_all_as_read(user, notification_types=None):
        ...
        try:
            ...
            log_error('Mark as read failed', exception=e, logger_instance=notifications_logger)
            raise
    ...
    def archive_old_notifications(days=30):
        ...
        try:
            ...
            log_error('Archive failed', exception=e, logger_instance=notifications_logger)
            raise
    ...
    def _push_websocket(user, notification):
        ...
        try:
            ...
            log_error('WebSocket push failed', exception=e, logger_instance=notifications_logger)
    ...
    def _push_websocket_batch(user_id, notifications):
        ...
        try:
            ...
            log_error('Batch WebSocket push failed', exception=e, logger_instance=notifications_logger)
    ...
    def _update_unread_badge(user):
        ...
        try:
            ...
            log_error('Badge update failed', exception=e, logger_instance=notifications_logger)
    ...
    def _queue_email_async(notification):
        ...
        try:
            ...
            log_error('Email queue failed', exception=e, logger_instance=notifications_logger)
    ...
    def notify_on_document_approved(document, approving_admin):
        ...
        NotificationService.create_notification(
            ...
            message=f'Votre document a été approuvé',
            document=document,
            priority='HIGH',
