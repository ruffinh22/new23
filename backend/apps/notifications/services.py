...
class NotificationService:
    ...
    def notify_on_document_approved(document, approving_admin):
        ...
        """
        admin_full_name = f"{approving_admin.first_name} {approving_admin.last_name}".strip()
        agent_full_name = f"{document.agent.first_name} {document.agent.last_name}".strip()
    ...
    def notify_on_document_rejected(document, rejecting_admin, reason=None):
        ...
        """
        admin_full_name = f"{rejecting_admin.first_name} {rejecting_admin.last_name}".strip()
        agent_full_name = f"{document.agent.first_name} {document.agent.last_name}".strip()
    ...
    def notify_on_document_deleted(document_title, agent, deleting_admin):
        ...
        """
        admin_full_name = f"{deleting_admin.first_name} {deleting_admin.last_name}".strip()
        agent_full_name = f"{agent.first_name} {agent.last_name}".strip()
